...
> [!NOTE]
> Currently, this config only works for TypeScript 6. It doesn't support TypeScript 7 yet. [Reason](https://github.com/typescript-eslint/typescript-eslint/issues/12518)
